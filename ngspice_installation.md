...
Once you have installed (copied) ngspice, you need to download the EKV 2.6 osdi file and copy it to the folder \<your ngspice installation path\>\Spice64\lib\ngspice\. You can download the osdi for Windows 10 and Windows 11 from my [EKV repository](https://github.com/chrisenz/EKV/tree/main/EKV2.6/va/code) ([download EKV 2.6 osdi file](https://github.com/chrisenz/EKV/tree/main/EKV2.6/va/code/ekv.
