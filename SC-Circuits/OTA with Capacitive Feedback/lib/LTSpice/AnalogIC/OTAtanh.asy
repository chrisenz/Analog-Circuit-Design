...
SYMATTR Value Gm=1u
SYMATTR Prefix X
SYMATTR Description Macromodel of a fully-differential OTA with tanh characteristic, saturation, thermal and flicker noise
SYMATTR SpiceModel OTAtanh
SYMATTR ModelFile analog.lib
SYMATTR Value2 A0=1000 fp=100MEG
SYMATTR SpiceLine Vios=0m Visat=80m
