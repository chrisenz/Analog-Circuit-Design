...
for k in range(0,Npts):
  jw=1j*2*pi*fthe[k]
  AvmagdBthe[k]=20*log(abs(Av(jw,Adcthe,wcthe,wzthe)))
  Avphidegthe[k]=np.angle(Av(jw,Adcthe,wcthe,wzthe),deg=True)
  AvmagdBthe2[k]=20*log(abs(Av(jw,Adcthe,wcthe,wzthe2)))
  Avphidegthe2[k]=np.angle(Av(jw,Adcthe,wcthe,wzthe2),deg=True)
