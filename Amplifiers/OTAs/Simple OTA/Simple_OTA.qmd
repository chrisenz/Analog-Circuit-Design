...
subtitle: For Generic 180nm Bulk CMOS Process (Version 2)
...
```{python}
CGS2=Cox*W2*L2*cgsi_ic(IC2)+CGSOp*W2
...
plt.plot([Vos/1e-6,Vos/1e-6],[0.885,Voutq],'k--', linewidth=lw)
plt.plot([Vidmin/1e-6,0],[Voutq0,Voutq0],'k--', linewidth=lw)
plt.plot([0,0],[0.885,Voutq0],'k--', linewidth=lw)
